...
export const useTerminalsTree = defineService(() => {
  ...
  useCommand('codetogether.focusSharedTerminal', (terminalId: string) => {
  ...
  useCommand('codetogether.closeSharedTerminal', (item?: any) => {
      ...
      return {
        treeItem: {
          ...
          command: {
            ...
            command: 'codetogether.focusSharedTerminal',
