...
if (values.help) {
  ...
  console.log(`codetogether WebSocket signaling server\n\n`
    + `Usage:\n  npx codetogether-ws-server@latest [options]\n\n`
    + `Options:\n`
    ...
    + `Examples:\n`
    + `  npx codetogether-ws-server@latest\n`
    + `  npx codetogether-ws-server@latest -p 9000\n`
    + `  npx codetogether-ws-server@latest --port 9000 --hostname 0.0.0.0  # IPv4 only\n`
    + `  npx codetogether-ws-server@latest --port 9000 --hostname ::       # Dual-stack\n`)
  process.exit(0)
}
